...
- ページ追加・変更の際は、必ずブランドガイドライン(Quiet Intelligence: シンプル・余白・高級感・信頼感・ミニマル)に沿っているか確認してください。特にHomepageは [PROMPTS/DESIGN/Homepage.md](../PROMPTS/DESIGN/Homepage.md) の指示に従ってください。
