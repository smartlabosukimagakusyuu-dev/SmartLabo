...
株式会社スマートラボのブランド資産(ロゴファイル、カラーコード、名刺デザイン、その他ブランド関連の実素材)を保管します。ブランドの思想的な背景は [PROJECT_BIBLE/04_Brand.md](../PROJECT_BIBLE/04_Brand.md) を参照してください。
...
- 新しいブランド素材を作成した場合は、[PROJECT_BIBLE/07_UI_UX_Rules.md](../PROJECT_BIBLE/07_UI_UX_Rules.md) の原則(シンプル・高級感・余白)に沿っているか確認してください。
...
- ブランド素材の変更(ロゴリニューアル等)は、[PROJECT_BIBLE/04_Brand.md](../PROJECT_BIBLE/04_Brand.md) の更新ルール(経営層承認)に従ってください。
