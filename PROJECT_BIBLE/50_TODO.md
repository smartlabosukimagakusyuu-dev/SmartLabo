...
- [ ] Homepageの別ロゴ案(角丸正方形+「+」マーク、[DESIGN_ASSETS/Icons/Reference/](../DESIGN_ASSETS/Icons/Reference/) 参照)を正式採用するかCEOに確認する(採用する場合は[00_Foundation/07_Brand_Identity.md](00_Foundation/07_Brand_Identity.md)のロゴ仕様を先に更新すること)
