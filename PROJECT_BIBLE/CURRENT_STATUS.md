...
| Last Update | 2026-08-07(WEB-V3-API-1: お問い合わせAPI正式構築。contact-apiを正式6種別〔お問い合わせ/無料相談/資料請求/デモ依頼/パートナー募集/採用〕へ統一し、件名【Smart Labo】＋種別・本文に送信日時/IPハッシュを追加。website-v3/contact.htmlの種別と?type=自動選択を6種別対応。ローカルPHP8.3で33/33件PASS。XServer本番へは未デプロイ・公開もしていない。ブランチfeature/web-v3-api-1-contact-api。レビュー=docs/reviews/WEB_V3_API_1_CONTACT_API.md) |
